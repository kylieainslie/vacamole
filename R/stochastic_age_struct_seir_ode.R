...
stochastic_age_struct_seir_ode <- function(times,init,params){
    ...
    # print("E")
    # print(E)
    n_E_I <- mapply(FUN = rbinom, n = 1, size = ifelse(E < 0, 0, round(E)), prob = p_E_I)
    #print(n_E_I)
    ...
    # print("I")
    # print(I)
    n_I_ <- mapply(FUN = rbinom, n = 1, size = ifelse(I < 0, 0, round(I)), prob = p_I_)
    #print(n_I_)
    ...
    # print("H")
    # print(H)
    n_H_ <- mapply(FUN = rbinom, n = 1, size = ifelse(H < 0, 0, round(H)), prob = p_H_)
    ...
    # print("IC")
    # print(IC)
    n_IC_ <- mapply(FUN = rbinom, n = 1, size = ifelse(IC < 0, 0, round(IC)), prob = p_IC_)
    ...
    # print("H_IC")
    # print(H_IC)
    n_HIC_ <- mapply(FUN = rbinom, n = 1, size = ifelse(H_IC < 0, 0, round(H_IC)), prob = p_HIC_)
