...
age_struct_seir_ode2 <- function(times, init, params) {
  with(as.list(c(params, init)), {
    ...
    dSv_3d <- (1/delay3) * Shold_3d - eta3 * lambda * Sv_3d - alpha4 * Sv_3d + (omega*4) * Rv_3d_3w + omega_ve * Sv_4d     
    dShold_4d <- alpha4 * Sv_3d - (1/delay4) * Shold_4d - eta3 * lambda * Shold_4d
    dSv_4d <- (1/delay4) * Shold_4d - eta4 * lambda * Sv_4d + (omega*4) * Rv_4d_3w  - omega_ve * Sv_4d # - alpha5 * Sv_4d 
