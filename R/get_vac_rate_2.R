...
#' @keywords vacamole
#' @export
get_vac_rate_2 <- function(times, vac_schedule, ve, t_ve_pf, t_ve_az){
    ...
    for(t in times){
      ...
      # comp_ve_dose1 <- c(0,rep(ve$astrazeneca[1],5),rep(0,3))
      # comp_ve_dose2 <- c(0,rep(ve$astrazeneca[2],5),rep(0,3))
      
      if(t >= t_ve_pf & t < t_ve_az){
