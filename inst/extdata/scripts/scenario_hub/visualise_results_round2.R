...
peak_incAB <- peak_inc %>%
  ...
  mutate(perc_change_mean = scales::percent((max_mean - max_mean[scenario_id == 'A-2022-07-24'])/max_mean[scenario_id == 'A-2022-07-24']),
         perc_change_q025 = scales::percent((max_q025 - max_q025[scenario_id == 'A-2022-07-24'])/max_q025[scenario_id == 'A-2022-07-24']),
         perc_change_q975 = scales::percent((max_q975 - max_q975[scenario_id == 'A-2022-07-24'])/max_q975[scenario_id == 'A-2022-07-24']))
