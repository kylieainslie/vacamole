...
# time
# column names are hardcoded in `convert_vac_schedule`
basis_5plus <- basis_5plus %>%
  mutate(pf_d1_10 = 0, 
         pf_d2_10 = 0, 
         mo_d1_10 = 0, 
         mo_d2_10 = 0, 
...
#TODO docs of rest of parameters
...
# 5+ ----------------------------------------------------------
#FIXME `forward_sim_func_wrap` throws error for contact matrices:
# Error in contact_matrices$june_2021$mean : $ operator is invalid for atomic vectors
